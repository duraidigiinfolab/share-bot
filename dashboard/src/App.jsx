  ...
  return (
    <>
      ...
      <footer className="dashboard-footer">
        <h3>⚠️ FINANCIAL DISCLAIMER & TERMS OF SERVICE</h3>
        <p>
          This dashboard and the automated trading software are provided for <strong>educational and informational purposes only</strong>. 
          The trading signals generated by this software do not constitute financial advice, investment recommendations, or an offer to buy/sell securities. 
        </p>
        <p>
          Algorithmic trading involves substantial risk of loss and is not suitable for every investor. The creators of this software accept no liability for any financial losses or damages incurred from using these signals. <strong>You trade entirely at your own risk.</strong>
        </p>
      </footer>
    </>
  );
